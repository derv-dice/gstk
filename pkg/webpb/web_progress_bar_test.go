...
// todo: Тест запускается вручную и нужен для того, чтобы проверить работу прогрессбара в браузере.
// 	Закомментирован чтобы все остальные тесты не зависали из-за него
//import (
//	"fmt"
//	"net/http"
//	"testing"
